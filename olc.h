...
int flag_value			args ( ( const struct flag_type *flag_table,
				         char *argument) );
int flag_settable_value         args ( ( const struct flag_type *flag_table,
                                         char *argument) );
...
bool check_recog                args( ( CHAR_DATA *ch, int snum, int bit ) );
...
DECLARE_OLC_FUN( aedit_link		);
DECLARE_OLC_FUN( aedit_reset		);
DECLARE_OLC_FUN( aedit_sreset		);
...
DECLARE_OLC_FUN( aedit_quest            );
DECLARE_OLC_FUN( aedit_journal          );
...
DECLARE_OLC_FUN( redit_oneway           );
DECLARE_OLC_FUN( redit_rcopy            );
...
DECLARE_OLC_FUN( medit_affect3		);  /* ROM */
...
DECLARE_OLC_FUN( medit_mcopy            );
DECLARE_OLC_FUN( medit_addeq            );
DECLARE_OLC_FUN( medit_deleq            );
