...
void            free_quest_data         args( (QUEST_DATA *quest) );
JOURNAL_DATA    *journal_free;
JOURNAL_DATA    *new_journal_data       args( (void) );
void            free_journal_data       args( (JOURNAL_DATA *quest) );

INT_LIST        *new_int_list   args( (void) );
void            free_int_list   args( (INT_LIST *int_list) );
...
BANKACCT_DATA *new_bankacct     args( ( void ) );
void free_bankacct              args( (BANKACCT_DATA *acct) );
