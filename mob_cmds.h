...
DECLARE_DO_FUN( do_mpinvoke     );
DECLARE_DO_FUN(	do_mpflee	);
DECLARE_DO_FUN(	do_mpotransfer	);
DECLARE_DO_FUN(	do_mpremove	);
DECLARE_DO_FUN( do_mpgrab       );
DECLARE_DO_FUN( do_mpresetprand	);
DECLARE_DO_FUN( do_mppeace	);
DECLARE_DO_FUN( do_mpput	);
DECLARE_DO_FUN( do_mprawdamage  );
DECLARE_DO_FUN( do_mpgiveexp    );
DECLARE_DO_FUN( do_mpboostskill );
DECLARE_DO_FUN( do_mpsetskill   );
DECLARE_DO_FUN( do_mpteleport   );
DECLARE_DO_FUN( do_mptell       );
DECLARE_DO_FUN( do_mprecogon    );
DECLARE_DO_FUN( do_mpbson       );
DECLARE_DO_FUN( do_mpbsoff      );
DECLARE_DO_FUN( do_mprecogoff   );
DECLARE_DO_FUN( do_mpzechoaround);
DECLARE_DO_FUN( do_mpsreset     );
DECLARE_DO_FUN( do_mpalert      );
DECLARE_DO_FUN( do_mpbankroll   );
